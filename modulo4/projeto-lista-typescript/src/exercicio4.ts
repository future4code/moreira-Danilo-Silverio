...
function setorMarketing (funcionarios: Pessoas): Pessoas {

    const filtroFuncionarios = funcionarios.filter((marketing) => {
        return marketing.setor === SETORES.MARKETING && marketing.presencial === true
    });
...
console.log(setorMarketing(colaboradores));