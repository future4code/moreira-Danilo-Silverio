...
//RESPOSTA: Utilizaria o comando tsc (nome do arquivo.extensão) no terminal para transpilar o arquivo.
//----------------------|
...
// RESPOSTA: Podemos escrever o caminho do arquivo no terminal para acessa-lo, no caso poderiamos fazer tsc ./src/(nome do arquivo.extensão)
//----------------------|

d) Existe alguma maneira de **transpilar** múltilplos arquivos de uma vez só? Caso conheça, explique como fazer. */
//RESPOSTA: O comando tsc sem nenhum parâmetro converte todos os arquivos com extensão ts, ou podemos rodar tsc com o nome de cada arquivo.
//----------------------|